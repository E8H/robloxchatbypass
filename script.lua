...
sex1:NewButton("@largeboobs", "ok", function()
local words = {
    '@largeboobs',
}
...
sex1:NewButton("@canisuckyoboobs", "ok", function()
local words = {
    '@canisuckyoboobs',
}
...
sex1:NewButton("@caniIickurpuzzy", "ok", function()
local words = {
    '@caniIickurpuzzy',
}
